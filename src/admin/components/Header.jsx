...
function Header() {
  return (
    <div>
    <div className="flex items-center justify-between  px-20 bg-blue-900 pb-50">
   <div></div>
     <div className='flex gap-3 mt-5 mb-5'>
       <div class="relative" id="input">
  <input
    placeholder="Search..."
    class="block w-full text-sm h-[40px] px-4 text-slate-900 bg-white rounded-[8px] border border-slate-200 appearance-none focus:border-transparent focus:outline focus:outline-2 focus:outline-primary focus:ring-0 hover:border-brand-500-secondary- peer invalid:border-error-500 invalid:focus:border-error-500 overflow-ellipsis overflow-hidden text-nowrap pr-[30px]"
  ...
  <div class="absolute top-3 right-3">
    ...
    >
      ...
      ></rect>
       ...
       <Link to={'/'} className='text-red-500 text-lg font-semibold '>
       <button className='bg-white px-5 p-1 rounded-md h-11'>Logout</button></Link>
    </div>    
    </div>  
    </div>
  )
